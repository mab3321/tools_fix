...
const Navbar = () => {
    ...
    return (
        <header className={`text-gray-400 bg-white drop-shadow-2xl w-full body-font ${stickyClass} z-50`} id="navbar">
            <div className="mx-auto flex items-center">
                ...
                <div className=" md:ml-auto hidden xl:flex lg:flex md:flex sm:hidden w-[90%] xl:w-[90%] lg:w-[90%] md:w-[94%] justify-center items-center">
                    <nav className="flex flex-wrap items-center text-base justify-center">
                        <a href='https://app.toolsfix.net/signup' className="mr-4 text-base font-semibold cursor-pointer p-2 text-[#454545] hover:text-stone-500 hover:border-b-2 hover:border-stone-500" id='btn'>Buy Subscriptions</a>
                        <a href='https://app.toolsfix.net/member' className=" mr-2 text-base font-semibold cursor-pointer p-2 text-[#454545] hover:text-stone-500 hover:border-b-2 hover:border-stone-500" id='btn'>Member Area</a>
                        <Link to='/youtubeMonetization' className=" mr-2 text-base font-semibold cursor-pointer p-2 text-[#454545] hover:text-stone-500 hover:border-b-2 hover:border-stone-500" id='btn'>Youtube Monetization</Link>
                ...
                <div className='flex relative'>
                    {toggleMenu
                        ?
                        <AiOutlineClose fontSize={0} className='text-black md:hidden cursor-pointer' onClick={() => { setToggleMenu(false) }} />
                        :
                        <HiMenuAlt4 fontSize={50} className='text-black md:hidden cursor-pointer' onClick={() => { setToggleMenu(true) }} />}
                    {toggleMenu && (
                        <ul className='z-10 fixed top-0 -right-2 p-3 w-[80vw] h-screen shadow-2xl md:hidden list-none flex flex-col justify-start items-end rounded-md blue-glassmorphism text-black text-xl animate-slide-in'>
                            <li className='text-xl w-full my-2'>
                                <AiOutlineClose fontSize={35} className='text-black md:hidden cursor-pointer' onClick={() => { setToggleMenu(false) }} />
                            </li>
                            <li className='my-2'>
                                <a href='https://app.toolsfix.net/signup' className="mr-4 text-base font-semibold cursor-pointer p-2" id='btn'>Buy Subscriptions</a>
                            </li>
                            <li className='my-2'>
                                <a href='https://app.toolsfix.net/member' className=" mr-2 text-base font-semibold cursor-pointer p-2" id='btn'>Member Area</a>
                            </li>
                            <li className='my-2'>
                                <Link to='/youtubeMonetization' className=" mr-2 text-base font-semibold cursor-pointer p-2" id='btn'>Youtube Monetization</Link>
                            </li>
                            {/*<li className='my-6'>*/}
                            {/*    <a target="_blank" href="https://wa.me/923218043010"*/}
                            {/*       className="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-bold rounded-full text-medium px-8 py-4 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"*/}
